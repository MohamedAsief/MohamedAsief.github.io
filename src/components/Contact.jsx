            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:asief0712@gmail.com" className="text-muted hover:text-light transition-colors">
                    asief0712@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919597670811" className="text-muted hover:text-light transition-colors">
                    +91 9597670811
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/MohamedAsief" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/mohamedasief/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* Twitter */}
                    <a href="https://x.com/Mohamed_Asief_" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
